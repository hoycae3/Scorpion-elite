...
# Dashboard
    ...
    # Página: Analizador
        ...
        st.markdown("<style>.stColumn > div {width: 20% !important; min-width: 120px;} .stSelectbox label {font-size: 28px !important; font-weight: bold !important;}</style>", unsafe_allow_html=True)
        with col1:
