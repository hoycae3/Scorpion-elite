...
# Dashboard
    ...
    # Página: Analizador
        ...
        st.markdown("<style>.stColumn > div {width: 20% !important; min-width: 120px;} .stSelectbox label {font-size: 60px !important; text-align: center !important; font-weight: bold !important;}</style>", unsafe_allow_html=True)
        with col1:
