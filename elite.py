...
""", unsafe_allow_html=True)
    ...
    # Página: Estadísticas
        ...
        with st.form("form_equipo", clear_on_submit=True):
            ...
            # Línea 2: Stats principales (compactas)
            ...
            with col_stats2[0]:
                promedio_corners = st.number_input("Corners", min_value=0.0, value=10.0, step=0.5, format="%.1f", key="eq_corners")
            with col_stats2[1]:
                promedio_tarjetas = st.number_input("Tarjetas", min_value=0.0, value=3.0, step=0.5, format="%.1f", key="eq_tarjetas")
            with col_stats2[2]:
                promedio_tiros = st.number_input("Tiros", min_value=0.0, value=12.0, step=0.5, format="%.1f", key="eq_tiros")
            with col_stats2[3]:
                promedio_tiros_arco = st.number_input("T.Arco", min_value=0.0, value=4.0, step=0.5, format="%.1f", key="eq_tarcos")
