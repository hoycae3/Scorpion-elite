...
with c3:
    ...
    st.markdown(f'<table style="width:100%;"><tr style="border-bottom:1px solid {BORDER};"><th style="color:{MUTED}; font-size:9px; text-align:left; padding:8px; width:30%;">CASA</th><th style="color:{MUTED}; font-size:9px; text-align:center; padding:8px;">1</th><th style="color:{MUTED}; font-size:9px; text-align:center; padding:8px;">X</th><th style="color:{MUTED}; font-size:9px; text-align:center; padding:8px;">2</th><th style="color:{MUTED}; font-size:9px; text-align:center; padding:8px;">*</th></tr>', unsafe_allow_html=True)
    for o in odds:
        cls = f'color:{ORANGE}; font-weight:bold;' if o[4] else 'color:white;'
        st.markdown(f'<tr style="border-bottom:1px solid {BORDER};"><td style="padding:8px; color:white; font-size:10px; text-align:left;">{o[0]}</td><td style="text-align:center; padding:8px; font-size:10px; {cls}">{o[1]}</td><td style="text-align:center; padding:8px; font-size:10px; {cls}">{o[2]}</td><td style="text-align:center; padding:8px; font-size:10px; {cls}">{o[3]}</td><td style="text-align:center; padding:8px; font-size:10px; {cls}">{"*" if o[4] else "-"}</td></tr>', unsafe_allow_html=True)
