...
with c3:
    ...
    st.markdown('</table><div style="text-align:center; margin-top:15px;"><a href="#" style="color:#22c55e; font-size:11px;">Ver todas las cuotas</a></div></div>', unsafe_allow_html=True)
